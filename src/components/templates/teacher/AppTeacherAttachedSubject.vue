  ...
  >
    <div class="header">
      <div class="info">
        ...
        <div class="tests-count">{{subject.tests.length}} тестів</div>
      </div>
    ...
    <app-fade-card :show="isOpened">
      <div class="content">
        <div
          ...
          class="no-items"
        >
          Ви ще не створили жодного теста в цьому предметі.
          <span
            class="create"
            @click="$emit('create')"
          >Створити тест</span>
        ...
        <div v-if="subject.tests.length">
          <div class="label">Ви створили {{subject.tests.length}} тестів у цьому предметі</div>

          <div class="tests">
            <div
              v-for="({ id, name }, index) in subject.tests"
              :key="index"
              class="test"
              @click="$router.push({
                name: 'testDevelop',
